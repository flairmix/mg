...
#рециркуляция на котел 2.0 МВт 
print("рециркуляция")
print("рассматривается для режима 70-40, на входе в котел t >= 60")
Q_hot_water_2_summer = hot_water_power * ((temp_t3 - temp_w1_summer) / (temp_t3 - temp_w1_winter))
G_boiler_2_summer = 1000 * Q_hot_water_2_summer / (temp_T1_summer_in - temp_T2_summer_in)
G_main_2_summer = 1000 * Q_hot_water_2_summer / (temp_T1_summer_out - temp_T2_summer_out)
print("нагрузка летняя на ГВС Gcal/h - ", Q_hot_water_2_summer)
print("расход летний котловой воды, т/ч - ", G_boiler_2_summer)
print("расход летний сетевой воды, т/ч - ", G_main_2_summer)
temp_min_boiler = 60
G_circle_2 = abs(round(G_boiler_2_summer * (temp_T2_summer_out - temp_min_boiler) / (temp_T1_summer_in - temp_min_boiler), 3))
print("расход на циркуляцию для котла 2,0 МВт, т/ч - ", G_circle_2)
dn_circle = calc.pipeDn(G_circle_2)
print("диаметр- ", dn_circle)
print("скорость в тр-де рециркуляции, м/с - ", round(calc.pipev(G_circle_2, dn_circle), 3))
print("---------------------------------------------")
