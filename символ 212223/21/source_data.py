...
hot_water_power_max = 0.57

losses_boiler_room = 0.01 * (sum(Q_boilers))
heating_boiler_room = 0.01 * (sum(Q_boilers))

# Общая тепловая мощность Gcal/h
POWER_sum_23 = heat_power + vent_power + hot_water_power_max + losses_boiler_room + heating_boiler_room
