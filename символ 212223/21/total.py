...
print("POWER, Gcal / h - ", round(source_data.POWER_sum_23
, 3))
...
G_main_outside = round(1000 * source_data.POWER_sum_23
 / (source_data.temp_T1_outside - source_data.temp_T2_outside), 3)
