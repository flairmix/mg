...
class Gas_system():
    def __init__(self):
        ...
        self.gas_pressure = 0                        #бар
        

    def gas_consution(self, list:source_data.Q_boilers, efficiency_boiler=0.92, heating_value=8000):
        """
        return gas consumption for list of boilers, m3/h
        Q_boiler - Gcal/h - boiler power 
        """
    ...
    def gas_consution_one(self, Q_boiler, efficiency_boiler=0.92, heating_value=8000):
        """
        return gas consumption for one boiler 
        Q_boiler - Gcal/h - boiler power 
        """
